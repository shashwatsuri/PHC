...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_file", type=str, default="sample_data/amass_copycat_take6_test.pkl")
    parser.add_argument("--out_file", type=str, default="data/amass/pkls/our_thing.pkl")
